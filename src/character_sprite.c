/* Character Mode mugshot renderer for Pokemon Lazarus v2.
 *
 * 159 character front pics are injected at CM_SPRITE_PTRS_ADDR (an additive
 ...
 * tools/find_sprite_api.py.
 *
 * Separate compile unit from character_mode.c on purpose: that shim is 1771 B
 * in the 2048 B window before BITMAPS_ADDR, so adding to it would overflow
 * into the bitmaps. This links at its own address in the sprite blobs' free
 * run and disturbs no existing layout.
 *
...
#error "compile with -DSPRITE_PTRS_ADDR=0x09xxxxxx"
#endif
...
#define LoadCompressedSpriteSheet   ((u16 (*)(const void *)) 0x080FCEE5)
#define LoadCompressedSpritePalette ((u8  (*)(const void *)) 0x080FCF9D)
#define CreateSprite  ((u8 (*)(const void *, s16, s16, u8)) 0x08003A41)
#define FreeSpriteTilesByTag   ((void (*)(u16)) 0x08005519)
#define FreeSpritePaletteByTag ((void (*)(u16)) 0x08005829)
...
#define gDummySpriteAnimTable       ((const void *) 0x08E68F18)
#define gDummySpriteAffineAnimTable ((const void *) 0x08E68F1C)
#define SpriteCallbackDummy         ((void (*)(void *)) 0x08004141)

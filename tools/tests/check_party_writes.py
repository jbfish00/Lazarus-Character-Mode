...
EXPECT_CALLEES = frozenset({0x083e7f2c, 0x081c2fac, 0x081c40b0})
...
INVENTORY = {
    0x000add76: ("UNVERIFIED",
                 "mon-sized copy into a party slot inside the 0x080ADD76 "
    ...
    0x001542b6: ("EXEMPT",
                 ...
                 "mons out and back"),
    0x001a2050: ("UNVERIFIED",
                 "mon-sized copy into a party slot inside the 0x081A2050 "
    ...
    0x001dd4c4: ("UNVERIFIED",
                 "mon-sized copy into a party slot inside the 0x081DD4C4 "
                 "region (callee 0x083E7F2C (memcpy)); containing routine "
                 "not yet identified. It reaches the party through a known "
                 "copy primitive, so it cannot be introducing a species by "
                 "an unknown mechanism -- but WHAT it copies is unexamined. "

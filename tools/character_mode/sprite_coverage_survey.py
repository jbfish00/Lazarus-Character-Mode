...
MANIFEST = "/home/jbfish00/Documents/Character Hacks/Lazarus-Character-Mode/tools/character_mode/characters_manifest.json"
...
assert len(chars) == 179, len(chars)
